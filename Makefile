...
SOURCE = $(SRC_DIR)/activity.c $(SRC_DIR)/activity_helper.c $(SRC_DIR)/activities_container_helper.c $(SRC_DIR)/activities_container_support_list.c $(SRC_DIR)/activities_container.c $(SRC_DIR)/utils.c $(SRC_DIR)/main.c
